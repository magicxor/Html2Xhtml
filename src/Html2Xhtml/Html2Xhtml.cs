...
{
    /// <summary>
    /// Html2Xhtml is a stream filter that converts HTML to XHTML. It is able to correct many
    /// common errors in input HTML.
    /// </summary>
    public static class Html2Xhtml
    {
        ...
        /// <param name="lineLength">Number of characters per line. The default value is 80. It must be greater or equal to 40, otherwise the parameter is ignored.</param>
        /// <param name="tabLength">Tab length in number of characters. It must be a number between 0 and 16, otherwise the parameter is ignored. Use 0 to avoid indentation in the output.</param>
        /// <param name="preserveSpaceComments">Use this option to preserve white spaces, tabs and ends of lines in HTML comments. The default, if not provided, is to rearrange spacing.</param>
        ...
        public static StreamReader RunAsFilter(
            ...
            int? lineLength = null,
            int? tabLength = null,
            bool preserveSpaceComments = false,
            ...
            bool dosEndOfLine = false)
        {
            var args = string.Join(" ",
                ...
                !preserveSpaceComments ? null : "--preserve-space-comments",
    ...
    public static class Html2XhtmlExtensions
    {
        ...
        /// </summary>
        /// <param name="html2xhtmlOutput">The output stream of Html2Xhtml.</param>
        ...
        {
            var xhtml1 = html2xhtmlOutput.ReadToEnd();
